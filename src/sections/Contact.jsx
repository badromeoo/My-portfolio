  ...
  return (
    <section id="contact" className="px-8 py-20">
      <div className="max-w-2xl mx-auto text-center">
        <h2 className="mb-4 text-3xl font-bold text-white md:text-4xl">Contact Me</h2>
        <p className="mb-12 text-lg text-slate-300">If you are interested in working together or have any questions, please feel free to contact me.</p>
        ...
        <form ref={form} onSubmit={sendEmail} className="space-y-6 text-left">
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              required
              className="block w-full px-3 py-2 mt-1 rounded-md shadow-sm bg-slate-800/50 border-slate-700 text-slate-200 focus:outline-none focus:ring-sky-500 focus:border-sky-500"
            ></textarea>
          </div>
        ...
        <div className="mt-12">
          <p className="text-slate-400">Or Contact Me Via:</p>
          <div className="flex justify-center mt-4 space-x-6">
            <a href="https://www.linkedin.com/in/i-made-bintang-astawa-865918273" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-sky-400">
              LinkedIn
            </a>
            <a href="https://github.com/badromeoo" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-sky-400">
              GitHub
            </a>
